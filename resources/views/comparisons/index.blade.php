...
<div class="comparison-container">
    ...
    @php
        ...
        foreach ($comparisons as $comparison) {
            ...
            } elseif ($categoryId !== $comparison->product->category_id) {
    ...
    @endphp
    @if($mixedCategories)
        <div class="alert alert-danger" style="margin-top:32px;">Ошибка: нельзя сравнивать товары из разных категорий. Удалите лишние товары из сравнения.</div>
