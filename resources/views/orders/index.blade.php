                ...
                <div class="order-header">
                    ...
                    @if($order['status'] === 'Новый')
                        <div class="order-actions">
                            <button type="button" class="btn btn-danger btn-delete-order" data-order-number="{{ $order['number'] }}">
                                Удалить
                            </button>
                        </div>
                    @endif
...
<!-- Модальное окно подтверждения удаления заказа (вне .container) -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            deleteForm.action = '/order-delete/' + orderNumber;
            deleteModal.show();
        });
    });
});
